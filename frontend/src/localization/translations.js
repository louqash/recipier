...
export const translations = {
  polish: {
    ...
    one_rounding_warning: 'Ostrzeżenie o zaokrągleniu składnika',
    multiple_rounding_warnings: '{count} ostrzeżeń o zaokrągleniu składników',
  ...
  english: {
    ...
    one_rounding_warning: 'Ingredient rounding warning',
    multiple_rounding_warnings: '{count} ingredient rounding warnings',
